...
class HrmLoanDocumentFactory extends Factory
{
    public function definition(): array
    {
        return [
            ...
            'branch_code' => $this->faker->numberBetween(1100, 9999),
            'branch_name' => $this->faker->city,
            'cif_id' => 'CIF' . $this->faker->numberBetween(100000, 999999),
            'account_number' => 'ACC' . $this->faker->numberBetween(1000000, 9999999),
            ...
            'glow_application_id' => 'GLW' . $this->faker->numberBetween(100000, 999999),
            'loan_amount' => $this->faker->numberBetween(10000, 99999),
            'barcode' => NULL,
            'added_at' => date('Y-m-d'),
