  ...
  <div class="pagelayout">
    ...
    <div class="contentmain">
     ...
     <label class="label-font"> LAN : <strong class="policy2">@foreach(str_split($data->load_acc_id) as $char)<span class="policy-box1">{{ $char }}</span>@endforeach</strong></strong></label> 
      ...
      <div class="contentrows">
        <label class="label-font"> Cause of Death : <strong class="policy2 {{ empty($data->cause_of_death)?'policyunderline': ''}}">{{$data->cause_of_death}}</strong></label>
        <label class="label-font "> Age as on Date of Death : </label><strong class="policyunderline1" >{{ $data->age}}</strong>
        <label>Years</label>
...
given in connection with this claim.</span><br>
      <span class="font_declaration">
  ...
  <div class="contentmain mr-right">  
    ...
    <div class="contentrows"></div>
     <strong class="contentrows">Declaration by Claimant</strong><br>
      <span class="font_declaration">I hereby  notify  the  Aditya  Birla  Sun  Life  Insurance  Company Limited (ABSLI) that<br> Mr./Ms./Master<strong class="declarationfillin"></strong> whose life was insured by the said company,
