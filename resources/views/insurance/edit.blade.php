...
<div class="col-3 mb-3">
   ...
      <option {{ ( (old('cliam_status',$data->cliam_status )==$value->claim_status))?'selected':''}} value="{{$value->claim_status}}">{{ (strlen($key+1)=='1'?'0':'' )}}{{$key+1}}-{{$value->claim_status}}</option>
    @endforeach
   </select>
...
<div class="row">
<div class="col-3 mb-3">
   <label class="form-label label-bold">Nominee Name as per Bank Records <span class="text-danger">*</span></label>
...
<div class="col-3 mb-3">
   <label class="form-label label-bold">Name of the Bank <span class="text-danger">*</span></label>
...
<div class="col-3 mb-3">
   <label class="form-label label-bold">Bank Account Number <span class="text-danger">*</span> </label>
...
<div class="col-3 mb-3">
   <label class="form-label label-bold">IFSC Code <span class="text-danger">*</span> </label>
...
<div class="col-3 mb-3">
   <label class="form-label label-bold">Bank Branch Name <span class="text-danger">*</span> </label>
...
<div class="col-3 mb-3">
   <label class="form-label label-bold">Nominee Contact No <span class="text-danger">*</span> </label>
