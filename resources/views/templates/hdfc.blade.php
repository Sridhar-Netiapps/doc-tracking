...
<head>
  ...
  <title>HDFC Group Claim Form</title>
  <style type="text/css" nonce="wUDPhZ1Z60inspnMCukimCi">
   ...
   .rowd {
      display: flex;
      align-items: center;
      gap: 3px; /* space between label and checkbox group */
      margin-bottom: 5px;
    }
...
.sec11sign-cell {
  ...
  vertical-align: top;
  text-align: left;
  /* Removed padding-left to eliminate end space */
}
...
<div class="pagelayout">
	<div class="innerborder">
         ...
         <tr>
           ...
           <td class="col-50 rightalign"><img class="logo" src="{{ $base64 }}"> </td>
			...
			<div class="contentborder">
			   ...
			   <div class="linespace">
			  	 <span class="content-label">Policy No.:  <strong>I4000188-0VWW000</strong>  Lending Institution/Master Policyholder Name: <strong>RAGHUNATH BARMAN</strong> </span>
			  </div>

			  <div class="heade-bg">
				  <label class="header-label">Insured Member Information</label> 
			  </div>

			  <div class="rown">
			  	<span class="content-label">Member Name :  </span><strong class="memname">RAGHUNATH BARMAN</strong>
          <span class="content-label"> Member No.: <strong>3510009009</strong> 
			  </div>

        <div class="rown">
          <span class="content-label">Date Of Birth :  </span><strong class="dob">10/10/1992</strong>
          <span class="content-label"> Certificate/Loan Id: <strong>3510009009</strong> 
        </div>
      ...
      <div class="contentborder">
        <div class="linespace heade-bg">
            <label class="header-label">Section I - Information regarding the Claimant</label> 
        </div>
        ...
        <div class="rowfullwidth">
         ...
         <div class="rowfullwidth">
          <span class="content-label">Address: </span><strong class="fullname"></strong>
          <span class="content-label"> Pin Code: </span><strong class="gender"></strong> 
        </div>
    ...
    <div class="contentborder">
        ...
        furnish details and reports as and when required by HDFC Life for processing this claim.</p>

        <p class="content-label">I/We, the Nominee/Nominees in respect of the insurance availed by the Member (details of the insurance are given in the below Table), consequent to the
        death of the Member, I/we, as the Nominee(s), am/are eligible to receive the insured amount from HDFC Life. For this purpose, I/we have made/ I/we
        am/are making the necessary claim application to HDFC Life. Since I am/we are required to pay the outstanding loan amount, as per the below table, to the
        Master Policyholder described below, I/we instruct and authorise HDFC Life to pay the amount, shown as outstanding in the table below to the Master
        Policyholder directly, and the balance amount be paid to me/us. Upon such payment by HDFC Life on my/our instructions and on my/our behalf to the
        ...
        <div class="sec11sign-table">
          <div class="sec11sign-row">
            <div class="sec11sign-cell">
              ...
              <div>
                <span class="content-label">Place:</span>
                <strong class="sec1date"></strong>
              </div>
            </div>
            ...
            <div class="sec11sign-cell">
              <div class="stamp">
                <span class="content-label">Revenue Stamp</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="innerborder">
    ...
    <div class="contentborder">
        ...
        <div class="sec11sign-table">
          <div class="sec11sign-row">
             ...
             <div class="sec11sign-cell">
              <div>
                <span class="content-label">Declarant Name:</span>
                <strong class="declarant"></strong>
              </div>
    ...
    <div class="contentborder">
        <div class="linespace heade-bg">
          <label class="header-label">Section IV – Consent to receive communication from HDFC Life </label> 
        </div>
        <p class="content-label">I/We hereby give my/our consent to receive communication from HDFC Life or its authorised representatives via phone (call/SMS). Further, I/we hereby give
        my/our consent to receive other related information from HDFC Life or its authorised representatives through electronic mode including but not
        limited to SMS, Email and WhatsApp.</p>
        <div class="sec11sign-table">
          <div class="sec11sign-row">

             <div class="sec11sign-cell">
              <div>
                <span class="content-label">Claimant Name:</span>
                <strong class="declarant"></strong>
              </div>
    ...
    <div class="contentborder">
        ...
        <div class="innercontentborder">
          <div class="linespace heade-bg">
            <label class="content-label">Credit Account Statement</label> 
          </div>
...
Outstanding Loan Balance referred under (d) above) payable to the insured on the happening ased member in case of death claims</td>
         ...
         <p class="content-label">I/We do hereby declare that the information/details furnished in the CREDIT ACCOUNT STATEMENT above is true, correct and complete in all aspects.</p>
        <div class="sec11sign-table">
          <div class="sec11sign-row">
